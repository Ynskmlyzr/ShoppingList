...
@HiltViewModel
class ShoppingListViewModel @Inject constructor (private val repository: ShoppingRepository, application: Application): BaseViewModel(application) {
    ...
    fun recordItem(dataShopList : ArrayList<ShoppingList>,id : Int){
        viewModelScope.launch {
            repository.updateShoppingList(dataShopList,id)
        }
    }

    fun recordItemTime(dataTime : String,id: Int){
        repository.updateTime(dataTime,id)
    }
